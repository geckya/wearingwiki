...
**Base Size** is the defined as the [woven wrap size](WovenWrapSizes.html) needed to do [Front Wrap Cross Carry](FrontWrapCrossCarry.html). Base Size can be affected by the size and shape of the wearer, size of the wearee, wrap thickness, taper depth, tightening ability/preference, how much clothing is being worn by the wearer and wearee, and wrapping qualities of the woven wrap.
